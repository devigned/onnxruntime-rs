...
[<img alt="build status" src="https://img.shields.io/github/workflow/status/devigned/onnxruntime-rs/Rust/master?style=for-the-badge" height="20">](https://github.com/nbigaouette/onnxruntime-rs/actions?query=branch%3Amaster)
...
[Microsoft's ONNX Runtime](https://github.com/microsoft/onnxruntime) (version 1.15).
...
* Linux x86_64
* macOS x86_64
* macOS aarch64 (no CI testing, see [#74](https://github.com/nbigaouette/onnxruntime-rs/pull/74))
* Windows i686
* Windows x86_64
